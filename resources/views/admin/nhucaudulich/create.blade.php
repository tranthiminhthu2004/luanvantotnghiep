...
@section('title', 'Thêm nhu cầu du lịch')
...
<div class="max-w-4xl mx-auto">
    ...
    <div class="bg-white rounded-3xl shadow p-8">
        ...
        <form action="{{ route('admin.nhucaudulich.store') }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <input type="text" name="ten_nhu_cau" value="{{ old('ten_nhu_cau') }}"
            ...
            <div class="mb-8">
                ...
                <textarea name="mo_ta" rows="5"
                    ...
                    placeholder="Nhập mô tả cho nhu cầu...">{{ old('mo_ta') }}</textarea>
