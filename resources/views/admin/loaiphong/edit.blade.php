            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <select name="ma_khach_san" class="w-full mt-2 border rounded-xl px-4 py-2.5 text-sm text-black">
                        ...
                        <option value="{{ $khachSan->ma_khach_san }}"
                            {{ old('ma_khach_san',$loaiPhong->ma_khach_san)==$khachSan->ma_khach_san ? 'selected' : '' }}>
                ...
                <div>
                    ...
                    <input type="text" name="ten_loai_phong"
                        value="{{ old('ten_loai_phong',$loaiPhong->ten_loai_phong) }}" placeholder="Ví dụ: Deluxe"
                ...
                <div>
                    ...
                    <input type="number" name="so_nguoi_toi_da"
                        value="{{ old('so_nguoi_toi_da',$loaiPhong->so_nguoi_toi_da) }}" placeholder="Ví dụ: 4"
                        class="w-full mt-2 border rounded-xl px-4 py-2.5 text-sm text-black">
                ...
                <div>
                    ...
                    <input type="number" name="dien_tich" value="{{ old('dien_tich',$loaiPhong->dien_tich) }}"
                        placeholder="Ví dụ: 35" class="w-full mt-2 border rounded-xl px-4 py-2.5 text-sm text-black">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="mo_ta" rows="5" placeholder="Nhập mô tả loại phòng..."
                        class="w-full mt-2 border rounded-xl px-4 py-2.5 text-sm text-black">{{ old('mo_ta',$loaiPhong->mo_ta) }}</textarea>
                ...
                <div>
                    ...
                    <select name="trang_thai" class="w-full mt-2 border rounded-xl px-4 py-2.5 text-sm text-black">
                        ...
                        <option value="1" {{ old('trang_thai',$loaiPhong->trang_thai)==1 ? 'selected' : '' }}>

                            Hoạt động

                        </option>

                        <option value="0" {{ old('trang_thai',$loaiPhong->trang_thai)==0 ? 'selected' : '' }}>
