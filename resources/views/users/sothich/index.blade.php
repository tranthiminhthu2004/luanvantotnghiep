                                ...
                                <div class="flex-1">
                                    ...
                                    <div class="mt-3 grid grid-cols-5 gap-3">
                                        ...
                                        @for($i=1;$i<=5;$i++) <label class="cursor-pointer text-center">
                                            ...
                                            <span
                                                class="w-4 h-4 rounded-full border border-slate-300 inline-flex items-center justify-center transition peer-checked:border-[#1040C5] peer-checked:bg-[#1040C5] peer-checked:ring-4 peer-checked:ring-blue-100">
                                            </span>
                    ...
                    <div class="mt-6 flex flex-col items-center gap-3">
                        ...
                        <div class="mt-8 flex flex-col sm:flex-row justify-between items-center gap-4">
                            ...
                            <a href="{{ route('users.index') }}"
                                class="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl border border-slate-300 bg-white text-slate-700 hover:border-[#1040C5] hover:text-[#1040C5] hover:bg-blue-50 transition">

                                Quay lại

                            </a>
                            <button type="submit"
                                class="inline-flex items-center justify-center gap-2 bg-[#1040C5] hover:bg-blue-700 text-white px-8 py-3 rounded-xl font-semibold shadow-sm transition">
